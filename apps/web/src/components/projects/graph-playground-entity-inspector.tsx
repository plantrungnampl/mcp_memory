...
import type { ProjectGraphEntityDetail, ProjectGraphNode } from "@/lib/api/types";
      ...
      <div className="mb-4 flex items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-[var(--vr-text-main)]">
            {selectedNode?.type ?? "Inspect facts, provenance, and jump deeper into the timeline."}
          </p>
        </div>
        <button
          ...
          <div className="rounded-[20px] border border-[var(--vr-divider)] bg-[var(--vr-graph-overlay)] p-4">
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2">
              <div className="rounded-2xl border border-[var(--vr-divider)] bg-[var(--vr-bg-card)] px-3 py-3">
                <p className="text-[11px] uppercase tracking-[0.16em] text-[var(--vr-text-dim)]">Facts</p>
                <p className="mt-2 text-2xl font-semibold text-[var(--vr-text-strong)]">{data.entity.factCount}</p>
              </div>
              <div className="rounded-2xl border border-[var(--vr-divider)] bg-[var(--vr-bg-card)] px-3 py-3">
                <p className="text-[11px] uppercase tracking-[0.16em] text-[var(--vr-text-dim)]">Episodes</p>
